...
func InitMySQL() {
	...
	// 可选: 自动迁移模型
	err = DB.AutoMigrate(&models.Account{}, &models.Item{}, &models.Claim{}, &models.LostCategory{}, &models.Image{}, &models.Announcement{}, &models.Feedback{}, &models.Message{}, &models.ChatList{})
	if err != nil {
