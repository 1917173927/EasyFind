...
const docTemplate = `{
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.AdminUpdateRecordRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/easyfind_internal_services.ItemStats"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.CreateFeedbackRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "easyfind_internal_services.ItemStats": {
            "type": "object",
            "properties": {
                "archived": {
                    "type": "integer"
        ...
        "internal_controllers.AdminUpdateRecordRequest": {
            "type": "object",
            "properties": {
                "campus": {
                    "type": "string"
        ...
        "internal_controllers.CreateFeedbackRequest": {
            "type": "object",
            "required": [
                "content",
                "type"
